local Config = {
    ['Key'] = 'teddyhubfreemium',
    ['Link Key'] = {
        ['Key 1'] = 'https://link4sub.com/QzgP',
        ['Key 2'] = '',
    },
}
...
Wallpaper.Image = "rbxassetid://127057715088982"
...
Status.Text = "TEDDY HUB [FREEMIUM]"
...
local Window = Fluent:CreateWindow({
    Title = "Teddy Hub-Auto Hop [FREEMIUM] ",
    SubTitle = "| by Vhaidz",
    TabWidth = 110,
...
Race = Window:AddTab({ Title = "Tự Động Lấy Tộc", Icon = "" }),    
Buy = Window:AddTab({ Title = "Tự Động Mua" }),
    Server = Window:AddTab({ Title = "Kiểm Tra Máy Chủ", Icon = "" }),
    Settings = Window:AddTab({ Title = "C� i Đặt", Icon = "" }),
    Shop = Window:AddTab({ Title = "Cửa H� ng", Icon = "" }),
}
...
Tabs.Servers:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/6UDDwybUh7")) 
        end
})
...
Tabs.Servers:AddButton({
    ...
    Description="Youtube",
    Callback=function()
        setclipboard(tostring("https://youtube.com/@teddybelll"))
    end
})
...
Tabs.Info:AddParagraph({
    Title="Phát Triển : TEDDY HUB",
    Content="Yeu Cac Em Vó Tu"
})
local executorName
...
local Input = Tabs.Status:AddInput("Input", {
        Title="Job ID",
        Default="",
        Placeholder="Dán Job ID V� o Đây",
        Numeric=false, 
        Finished=false, 
...
Tabs.Main:AddButton({
    Title = "Hop Galley Captain",
    Description = "Đợi 5s bấm 1 lần",
    Callback = function()
        wait(5)
         loadstring(game:HttpGet("https://raw.githubusercontent.com/iamnoxxx/Codex/main/Galley%20Captain.lua"))()
    end
})
